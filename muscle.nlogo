...
to setup
  ...
  set rejection? false
  set rejection-time 0
  set intensity-temp intensity
  set hours-of-sleep-temp hours-of-sleep
  set days-between-workouts-temp days-between-workouts
  reset-ticks
end
...
to perform-daily-activity
  ...
  ask muscle-fibers [
    set catabolic-hormone catabolic-hormone + 2.0 * (log catabolic-hormone 10)
    set anabolic-hormone anabolic-hormone + 2.5 * (log anabolic-hormone 10)
  ]
end
...
to grow  ;; turtle procedure
  ...
  set fiber-size (fiber-size - 0.20 * growth-rate * (log catabolic-hormone 10))
  set fiber-size (fiber-size + 0.20 * growth-rate * min (list (log anabolic-hormone 10)
